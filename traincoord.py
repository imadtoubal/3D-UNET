...
# %%
X,  Y  = load_dataset(cfg['data']['train_path'], addcoords=True, coords_only=True)
Xv, Yv = load_dataset(cfg['data']['val_path'], addcoords=True, coords_only=True)
...
for net in nets:
    ...
    model_name = '/model_{}_coord_only.p5'.format(net)
    ...
    callbacks = [
                ...
                tf.keras.callbacks.TensorBoard(log_dir='logs_coords/fit/{}'.format(model_name), profile_batch=0)
                ]
