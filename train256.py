...
for net in nets:
    ...
    loss = fl()
    model = nets[net](256, 256, 64, 1, loss=loss)
    # print(net, model.count_params())
    model_name = '/256_model_{}_fl.p5'.format(net)
    ...
    callbacks = [
                ...
                tf.keras.callbacks.TensorBoard(log_dir='logs256/fit/{}'.format(model_name), profile_batch=0)
                ]
